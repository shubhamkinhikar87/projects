...
<!-- <--login--> -->
	...
	<div class="container">
                       ...
                       <h1>
		 <span><center>Upcoming tech-talk</center></span>
	</h1>

	<table class="responstable">

		<tr><th>Tech-Talk Id</th>
			<th>Date</th>
		...
		<c:forEach items="${sessionScope.techTonicData}" var="techtalk">
			<tr><td><c:out value="${techtalk.id}" /></td>
				...
				<td><a href="updateHandler?id=${techtalk.id}"><button>Update</button></a></td>
			    <td><a href="deleteHandler?id=${techtalk.id}"><button>Delete</button></a></td> 
			     <td><a href="audienceController?id=${techtalk.id}"><button>interested</button></a></td> 
	...
	<form action="addTechTalk.jsp" width=100%>

		<div style="text-align: center;">
			<button type="submit" class="btn">Add Tech-Talk!</button>
		</div>
	</form>
	<script
